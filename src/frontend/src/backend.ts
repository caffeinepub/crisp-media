...
import type { ExternalBlob as _ExternalBlob, PortfolioItem as _PortfolioItem, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addPortfolioItem(arg0: string, arg1: string, arg2: ExternalBlob, arg3: string, arg4: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addPortfolioItem(arg0, arg1, await to_candid_ExternalBlob_n8(this._uploadFile, this._downloadFile, arg2), arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async invertOrderPortfolioItem(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.invertOrderPortfolioItem();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async movePortfolioItemToEnd(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.movePortfolioItemToEnd(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async reorderPortfolioItems(arg0: Array<ReorderPortfolioItem>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.reorderPortfolioItems(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updatePortfolioItem(arg0: bigint, arg1: string | null, arg2: string | null, arg3: ExternalBlob | null, arg4: string | null, arg5: string | null): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updatePortfolioItem(arg0, to_candid_opt_n17(this._uploadFile, this._downloadFile, arg1), to_candid_opt_n17(this._uploadFile, this._downloadFile, arg2), await to_candid_opt_n18(this._uploadFile, this._downloadFile, arg3), to_candid_opt_n17(this._uploadFile, this._downloadFile, arg4), to_candid_opt_n17(this._uploadFile, this._downloadFile, arg5));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_PortfolioItem_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _PortfolioItem): Promise<PortfolioItem> {
...
async function from_candid_vec_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_PortfolioItem>): Promise<Array<PortfolioItem>> {
    return await Promise.all(value.map(async (x)=>await from_candid_PortfolioItem_n14(_uploadFile, _downloadFile, x)));
}
