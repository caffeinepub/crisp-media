...
export interface _SERVICE {
  ...
  'invertOrderPortfolioItem' : ActorMethod<[], undefined>,
  'isCallerAdmin' : ActorMethod<[], boolean>,
  'movePortfolioItemToEnd' : ActorMethod<[bigint], undefined>,
  'reorderPortfolioItems' : ActorMethod<
    [Array<ReorderPortfolioItem>],
    undefined
  >,
